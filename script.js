...
function updateChakraDisplay() {
    if(playerOneTurn) {
        document.getElementById('number-display').textContent = `* Player 1's Chakra: ${remainingChakra}, Vetoes: ${vetoesPlayerOne}, Prodigy Picks: ${ppPlayerOne}`;
        document.getElementById('number-display-two').textContent = `Player 2's Chakra: ${opponentRemainingChakra}, Vetoes: ${vetoesPlayerTwo}, Prodigy Picks: ${ppPlayerTwo}`;
    }
    else {
        document.getElementById('number-display').textContent = `Player 1's Chakra: ${remainingChakra}, Vetoes: ${vetoesPlayerOne}, Prodigy Picks: ${ppPlayerOne}`;
        document.getElementById('number-display-two').textContent = `* Player 2's Chakra: ${opponentRemainingChakra}, Vetoes: ${vetoesPlayerTwo}, Prodigy Picks: ${ppPlayerTwo}`;
